export default function Card({
  ...
  return (
    <div
      className={`flex flex-col items-start justify-center gap-y-2 w-full rounded-2xl p-6 text-left ${container1} ${className}`}
    >
      ...
      <div className={`flex items-center justify-center ${container2}`}>
        ...
        <div className="flex items-center justify-center gap-x-1">
          <div className="text-xs leading-[18px]">{text2}</div>
          <img
