...
const ProductOne = () => {
    ...
    return (
        <div class='h-full'>
            ...
            <div class='mt-[-50px] bg-white w-full h-full flex p-7 flex-col z-20 relative rounded-t-3xl'>
                ...
                <div class='flex items-center z-40 bottom-0 gap-3 p-2 fixed w-full bg-white border-t'>
                       <button class='w-full py-3 rounded-full font-["Semibold"] text-sm border'>Back</button>
